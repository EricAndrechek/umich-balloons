...
class LoRaMessage(BaseModel):
    ...
    message_id: Optional[uuid.UUID] = Field(..., description="Message ID, new for each message to prevent duplicates. This is generated by the LoRa receiver if it is not included in the raw data.")
    sender: str = Optional[Field(..., description="Recipient of the original LoRa message and the device making this POST to the server. Can be callsign or other, auto-generated as IP if not included.")]
