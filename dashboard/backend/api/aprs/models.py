...
class APRSMessage(BaseModel):
    ...
    message_id: Optional[uuid.UUID] = Field(..., description="Message ID, new for each message to prevent duplicates. This is generated by the APRS receiver if it is not included in the raw data.")
