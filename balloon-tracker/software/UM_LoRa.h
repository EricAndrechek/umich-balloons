...
#define LORA_CLK_PIN A0
#define LORA_MOSI_PIN A5
#define LORA_MISO_PIN A1

class LoRaClass : public Stream {
public:
  LoRaClass();

  int begin(long frequency, Adafruit_MCP23X08* mymcp);
  void end();
  ...
  void setMcp(Adafruit_MCP23X08* mymcp);
