...
Simulates a balloon (KF8ABL-11) drifting NE from Ann Arbor, ascending slowly.
Sends telemetry via four paths, staggered evenly across each tick:
  ...
  2. APRS push – POST /aprs on the relay (15s later)
  3. LoRa push – POST /lora on the relay (30s later)
  4. Iridium   – POST /iridium on the relay, JWT skipped in dev mode (45s later)
